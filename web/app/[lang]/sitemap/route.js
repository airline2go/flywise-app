// Localized HTML sitemap hub (/en/sitemap, /ar/sitemap, …). Route Handlers
// aren't wrapped by [lang]/layout.js, so the language prefix is validated here:
// an unknown or default-language (/de/sitemap) prefix 404s, matching how the
// other localized entity handlers behave (German lives unprefixed at /sitemap).
...
export async function GET(_req, { params }) {
  ...
  return htmlResponse(await renderSitemapHtml(lang));
}
